...
$dir="/172653/email-marketing/3.0/sports/banners";
...
echo("
<!-- Trigger the Modal -->
<img id='myImg{$i}' class='myImg' src='https://web.static.nowtv.com/email-marketing/3.0/sports/banners/{$dirlist[$i]["name"]}' alt='{$dirlist[$i]["name"]}' style='max-height:100px' onClick='displayModel(`myImg{$i}`,`myModal{$i}`,`img{$i}`, `caption{$i}` )'>
