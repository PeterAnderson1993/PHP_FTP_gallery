...
$dir="/172653/email-marketing/2.0/sports_content_hero";
...
echo("
<!-- Trigger the Modal -->
<img id='myImg{$i}' class='myImg' src='https://web.static.nowtv.com/email-marketing/2.0/sports_content_hero/{$dirlist[$i]["name"]}' alt='{$dirlist[$i]["name"]}' alt='{$dirlist[$i]["name"]}' style='max-height:100px' onClick='displayModel(`myImg{$i}`,`myModal{$i}`,`img{$i}`, `caption{$i}` )'>
