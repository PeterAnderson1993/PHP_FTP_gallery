...
<img id='myImg{$i}' class='myImg' src='https://web.static.nowtv.com/email-marketing/{$dirlist[$i]["name"]}' alt='{$dirlist[$i]["name"]}' alt='{$dirlist[$i]["name"]}' style='max-height:100px; padding:10px;' onClick='displayModel(`myImg{$i}`,`myModal{$i}`,`img{$i}`, `caption{$i}` )'>
</div>
